...
//$SxGeo = new SxGeo('SxGeoCity.dat', SXGEO_FILE | SXGEO_MEMORY); // Самый производительный режим, если нужно обработать много IP за раз

$ip = $_SERVER['REMOTE_ADDR'];

var_export($SxGeo->getCountry($ip)); // возвращает двухзначный ISO-код страны
echo '<br><br>';
